...
from Aplicacion1.models import Cliente, Proveedor, Producto
from Aplicacion1.forms import ClienteFormulario, ProveedorFormulario, BusquedaproductoFormulario
...
def vista_cliente(request):
    ...
    if request.method == "POST":
        ...
        if formulario.is_valid():
            ...
            return render(request, r'Aplicacion1\cliente.html',{"formulario":formulario})        
...
def vista_proveedor(request):
    ...
    if request.method == "POST":
        ...
        if formulario.is_valid():
            ...
            return render(request, r'Aplicacion1\proveedor.html',{"formulario":formulario})        
...
def vista_producto(request):
    ...
    return render(request, r'Aplicacion1\producto.html',{"formulario":formulario, "producto_buscado":producto_buscado})